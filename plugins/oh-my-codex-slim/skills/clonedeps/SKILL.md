...
```gitignore
# BEGIN oh-my-codex-slim clonedeps
.slim/clonedeps/repos/
# END oh-my-codex-slim clonedeps
```

Update `.ignore` so Codex can read the cloned source while git still ignores
it:
