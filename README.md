...
bunx --bun --package git+https://github.com/YanzuoLu/oh-my-codex-slim.git#v0.2.1 oh-my-codex-slim install
```
...
```sh
bunx --bun --package git+https://github.com/YanzuoLu/oh-my-codex-slim.git#v0.2.1 oh-my-codex-slim rollback
```

Roll back to a specific backup:

```sh
bunx --bun --package git+https://github.com/YanzuoLu/oh-my-codex-slim.git#v0.2.1 oh-my-codex-slim rollback --backup /path/to/.codex/omc-slim-backups/<timestamp>
```
